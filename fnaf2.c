...
XAbank soundBank = {
        ...
        0,
        {
            ...
            {   13, 677440,   1,     9 ,   22600, 24912, -1  }, //puppet music.xa 
            {   14, 1546432,   1,     9 ,   26408, 31696, -1  } //checking.xa 
        }
};
// XA file to load
...
void starting(void) {
  ...
  Ran(240);
  toychicafoolness = RAN + 60;
  Ran(240);
  manglefoolness = RAN + 60;
  Ran(240);
  BBfoolness = RAN + 60;
...
int main(void) {
    ...
    {   
        ...
        if (menu == 3) { //Gameplay Screen
            ...
            if (officequeuetimer > 0) {officequeuetimer--;}
            ...
            */ 
            ...
            if (camera == 1) {     
              if (night != 725255 && fivetosixamframes == 0) {
                  ...
                  if (phoneguytalkingconst - 1620 < phoneguytalking) {
                    polymutecall = (POLY_FT4 *)nextpri;                 
                ...
                if (toychicalocation == 3) { //Party room 4
                    MovVectortoychica.vx = 12;
                    MovVectortoychica.vy = -13;
                    if (curcam[0] == '0' && curcam[1] == '4') {
                      if (blinkicon > 30 || radar == 1) {
                        animatronicscamera[6] = 2;
                      } else {
                ...
                if (toychicalocation == 4) { //Party room 1
                ...
                if (toychicalocation == 5) { //L.Vent (in)
                    MovVectortoychica.vx = -46;
                    MovVectortoychica.vy = 33;
                    if (curcam[0] == '0' && curcam[1] == '5') {
                      if (blinkicon > 30 || radar == 1) {
                ...
                if (toychicalocation == 6){ //L.Vent (out)
                    animatronicscamera[6] = 0;
                }
                ...
                if (manglelocation == 4) { //Party Room 2
                    MovVectormangle.vx = 0;
                ...
                if (manglelocation == 6 || manglelocation == 7) { //R. Vent (out)
                    animatronicscamera[7] = 0;
                }
...
void timeFunc(void) {
      ...
      seedrandom = seedrandom + FrameCounter; // This gonna be huge
        ...
        if (animatronicategorie == 3) {
            ...
            if (menuselection == 2) {
                if (pad & PADLright) { //Golden Freddy
                    if (limiterpadright == 0) {
                        goldenfreddydifficulty++;
                        if (goldenfreddydifficulty > 20) {goldenfreddydifficulty = 0;}
                        limiterpadright = 1;
                        SpuSetKey(SPU_ON, SPU_10CH);
                    }
                }
                if (pad & PADLleft) { //Golden Freddy
                    if (limiterpadleft == 0) {
                        goldenfreddydifficulty--;
                        if (goldenfreddydifficulty < 0) {goldenfreddydifficulty = 20;}
                        limiterpadleft = 1;
                        SpuSetKey(SPU_ON, SPU_10CH);
                    }
                }
...
void AImoving(void) {
    if (animatronicscamera[0] == 0) {freddylocationframe--;}
    if (animatronicscamera[1] == 0) {bonnielocationframe--;}
    if (animatronicscamera[2] == 0) {chicalocationframe--;}
    foxylocationframe--;
    ...
    if (bonnielocation == 5) {
      for (int i = 0; i < 5; i++){ if (officequeue[i] == 0){ officequeue[i] = 2; break;}}
      bonnielocation++;
    }
    if (freddylocation == 4) {
      for (int i = 0; i < 5; i++){ if (officequeue[i] == 0){ officequeue[i] = 1; break;}}
      freddylocation++;
    }
    if (chicalocation == 4) {
      for (int i = 0; i < 5; i++){ if (officequeue[i] == 0){ officequeue[i] = 3; break;}}
      chicalocation++;
    }
    if (toyfreddylocation == 4) {
      for (int i = 0; i < 5; i++){ if (officequeue[i] == 0){ officequeue[i] = 5; break;}}
      toyfreddylocation++;
    }
    ...
    if (toychicalocation == 6) {
      if (ismaskon == 1) {
        toychicafoolness--;
        if (toychicafoolness == 0) {
          toychicalocation = 1;
          ventbanging = 1;
          Ran(240);
          toychicafoolness = RAN + 60;
        ...
        if (toychicadifficulty > RAN) {
            if (toychicalocation < 6) {
              ...
              if (!(toychicalocation == 2 && lighthall == 1)) {toychicalocation++;}
                if (toychicalocation == 6 && light1 == 1) {
                    sideFunc(0);
                    LightFunc();
                }
                if (toychicalocation == 5) {ventbanging = 1;}
